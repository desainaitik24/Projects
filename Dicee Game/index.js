...
// document.querySelector("img1,img2").style.animationName="dice";
// document.querySelector("img1,img2").style.animationDuration="2s";
// document.querySelector("img1,img2").style.animationIterationCount="1";
